package com.arnis.konductor.lint;
...
public class ControllerChangeHandlerDetectorTest extends LintDetectorTest {
    ...
    public void testWithNoConstructor() throws Exception {
        @Language("JAVA") String source = ""
                + "package test;\n"
                + "public class SampleHandler extends com.arnis.konductor.ControllerChangeHandler {\n"
                + "}";
    ...
    public void testWithPrivateClass() throws Exception {
        @Language("JAVA") String source = ""
                + "package test;\n"
                + "private class SampleHandler extends com.arnis.konductor.ControllerChangeHandler {\n"
                + "    public SampleHandler() { }\n"
                + "}";
